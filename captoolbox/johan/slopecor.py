...
Example:
    ...
    python slopecor.py '/mnt/devon-r0/shared_data/envisat/grounded/*.h5' -s /mnt/devon-r0/shared_data/DEMs/bedmap2_surface_wgs84_2km_slope.tif -a /mnt/devon-r0/shared_data/DEMs/bedmap2_surface_wgs84_2km_aspect.tif -u /mnt/devon-r0/shared_data/DEMs/bedmap2_surface_wgs84_2km_curve.tif -m RM -v lon lat h_cor r_ice1_cor -l 1.5 -d -g A -n 16
